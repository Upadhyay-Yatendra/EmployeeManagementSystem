...
const FormSection = (props) => {
    ...
    const formComponents = {
        ...
        salary: (key, props) => <SimpleInput key={key} {...{ ...props, value: salary, onChange: (value) => setSalary(value) }} />,
        ...
        submitButton: (key, props) => <Button key={key} {...{...props, text: 'Submit', onClickBtn: handleSubmit }} />,
        customMessage: (key, props) => (
            !isUpdateOperation ? (
              <div key={key} className="custom-message">
                <p>Since you are not an admin, you cannot update or delete the data.</p>
                <Button {...props} cancel={true} onClickBtn={() => navigate(-1)}>
                  Cancel
                </Button>
              </div>
            ) : null
    ...
    <div className='formSection'>
      <form onSubmit={handleSubmit}>
        ...
        <div className="buttons">
            ...
            {formComponents.customMessage('custom-message')} 
        </div>
      </form>
    </div>
  )
